...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Medical Sangallo Riabilitazione blog</title>
    ...
    <div class="nav-inner">
        ...
        <div class="nav-menu">
            <ul class="nav uppercase condensed bold">
                ...
                <li><a href="index.php#about" class="scroll">chi siamo</a></li>
                <li><a href="index.php#services" class="scroll">servizi</a></li>
                <li><a href="index.php#features" class="scroll">cosa facciamo</a></li>
                ...
                <li><a href="index.php#contact" class="scroll">contatti</a></li>
            </ul>
...
<section class="page_header container waypoint">
    <div class="page_header_inner">
        <!-- Header -->
        <h1 class="page_head normal t-center">
            Medical Sangallo, il Blog
        </h1>
        <!-- Description -->
