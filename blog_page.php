...
<body>
	...
	<section id="navigation" class="visible-nav white-nav">
		...
		<div class="nav-inner">
          ...
          <li class="dropdown-toggle nav-toggle active" ><a class="scroll">blog<b data-toggle="dropdown" class="caret"></b></a>
						<!-- DropDown Menu -->
	...
	?>
  	...
  	<footer class="footer">
  		...
  		<!-- Copyright -->
  		<p class="copyright normal">© 2016 Tutti i diritti Riservati. Designed by <a href="http://giannitoniolo.it" target="_blank" class="white">GTD</a></p>
  	</footer><!-- End Footer -->
